...
export const OrderConfirmation = () => {
  ...
  const onSuccess = (data) => {
    ...
    if (product && product.latitude && product.longitude) {
      fetchPlaceName(product.latitude, product.longitude);
    }
  };
    ...
    <section className="py-8 antialiased md:py-16 mt-10">
      <div className="mx-auto w-1/3 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6 md:mb-8 mt-6">
          ...
          ha sido recibido y será procesado. Ahora, el vendedor será notificado
          y deberá coordinar contigo los detalles para la entrega del producto.
