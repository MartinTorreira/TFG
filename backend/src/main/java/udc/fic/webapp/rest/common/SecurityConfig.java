...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.antMatchers(HttpMethod.GET, "/purchase/*/countSales").authenticated()
				.antMatchers(HttpMethod.GET, "/purchase/*/countRefundedSales").authenticated()
				.antMatchers(HttpMethod.GET, "/purchase/*/countCompletedSales").authenticated()
