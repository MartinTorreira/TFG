        ...
        return (
          <div className="flex flex-col gap-4 mt-20 px-20">
            <div className="flex flex-row items-start space-x-2 font-medium">
              ...
              <p className="font-normal">{totalPrice.toFixed(2).replace(".", ",")} €</p>
            </div>
            <div className="flex flex-row items-center">
              <label className="mb-2 text-lg font-semibold text-left w-full">Precio total de la oferta</label>
              <input
                type="number"
                min="0"
                value={desiredPrice}
        ...
        case 2:
          return (
            <div className="flex flex-col gap-6 px-36 mt-20">
              <h3 className="text-lg font-semibold text-center">Resumen de la oferta</h3>
                  ...
                  (product) =>
                    quantities[product.id] > 0 && (
                      ...
                      >
                        ...
                        <span>
                          {quantities[product.id]} x {product.price?.toFixed(2).replace(".", ",")} €
                        </span>
                      </div>
                    ),
                )}
    ...
    <div className="w-full flex flex-col h-full">
      ...
      <div className="flex flex-row pt-2">
        ...
        <button
          ...
          className="flex flex-row items-center justify-center  rounded-full px-2 p-1 text-accent-dark font-medium"
        >
          <p className="">{activeStep === steps.length - 1 ? "Finalizar" : "Siguiente"}</p>
