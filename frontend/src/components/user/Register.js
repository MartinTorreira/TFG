  ...
  return (
    <section className="mt-20">
      <div className="flex flex-col items-center justify-start px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="bg-gray-50 rounded-lg shadow-md w-full max-w-screen-md xl:max-w-screen-md p-6 space-y-4 md:space-y-6 sm:p-8 border-2 border-gray-200">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <div className="flex flex-col md:flex-col lg:flex-row gap-x-4">
            ...
            <div className="flex">
              <FileUpload onFileChange={handleSubmitAvatar} label={"Avatar"} />
            </div>
            ...
            <section className="flex mt-20">
              <button
                ...
                type="submit"
                className="w-full bg-accent-darker text-white border hover:opacity-90 transition-all focus:ring-4 focus:outline-none focus:ring-accent font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                Crear cuenta
              </button>
            </section>
