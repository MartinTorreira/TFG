  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-2">
        <button
          className="w-full bg-accent-darker text-white font-medium py-2 rounded hover:opacity-80 transition duration-200"
          onClick={applyFilters}
        >
          Aplicar filtros
        </button>
        <button
          className="w-full text-red-400 font-medium py-2 border border-red-400 rounded hover:bg-red-50 transition-all"
