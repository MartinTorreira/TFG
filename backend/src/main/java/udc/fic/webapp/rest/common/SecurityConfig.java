...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.antMatchers(HttpMethod.GET, "/user/*/averageRating").permitAll()
				...
				.antMatchers(HttpMethod.GET, "/purchase/*/getSellerId").authenticated()
				.antMatchers(HttpMethod.GET, "/purchase/*/countPurchases").authenticated()
				.antMatchers(HttpMethod.GET, "/purchase/*/countRefundedPurchases").authenticated()
				.antMatchers(HttpMethod.GET, "/purchase/*/countCompletedPurchases").authenticated()
				...
				.antMatchers(HttpMethod.POST, "/user/*/rate").authenticated()
